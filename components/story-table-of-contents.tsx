...
const StoryTableOfContents = ({ content }: StoryTableOfContentsProps) => {
      ...
      <div className="lg:sticky lg:top-24">
        ...
        <div className="mt-4 bg-zinc-50 border border-zinc-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs font-semibold text-zinc-900">Share Story</p>
          </div>
...
export default StoryTableOfContents;
