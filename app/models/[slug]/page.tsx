      ...
      <main className="flex flex-col min-h-screen gap-4 justify-start items-center relative">
        ...
        <section className="w-full max-w-7xl px-4 flex mt-20 flex-col gap-8 justify-start items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            <div className="animate-pulse bg-neutral-200 aspect-square rounded-lg h-96"></div>
            <div className="flex flex-col gap-4">
              <div className="animate-pulse bg-neutral-200 h-8 w-3/4 rounded"></div>
              <div className="animate-pulse bg-neutral-200 h-4 w-full rounded"></div>
              <div className="animate-pulse bg-neutral-200 h-4 w-5/6 rounded"></div>
              <div className="animate-pulse bg-neutral-200 h-4 w-3/5 rounded"></div>
            </div>
          </div>
          <div className="animate-pulse bg-neutral-200 h-96 w-full rounded"></div>
        </section>
        <Footer />
      </main>
    );
          ...
          <div className="grid pb-5 gap-4 mt-5 w-full grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex w-full flex-col gap-1">
              <div className="flex w-full justify-between">
                ...
                <p className="text-neutral-600">{selectedProduct.category}</p>
              </div>
              <span className="w-full h-1 bg-neutral-400"></span>
            </div>
          </div>
          ...
          <section className="w-full flex mt-15 flex-col gap-2 justify-start items-start">
            ...
            <div className="grid w-full mt-5 grid-cols-2 gap-2">
              {selectedProduct.available_accessories.slice(0, 3).map((acc) => (
                <span
                  key={acc.id}
                  className="w-full bg-neutral-100 rounded aspect-square cursor-pointer"
