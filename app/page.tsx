...
const MapboxMap = dynamic(() => import('@/components/map-box'), {
  ssr: false,
});

// ❗ OffersSection only needs ssr:false if it uses DOM/animations.
// If not → keep SSR. (I leave SSR ON for now.)
import OffersSection from '@/components/offers-section';

// ―――――――――――――――――――――――――――――――――――――――
// SSR COMPONENTS (keep for SEO & performance)
// ―――――――――――――――――――――――――――――――――――――――
    ...
    <main className="flex flex-col bg-white justify-center items-center relative">
      ...
      <section className="w-full lg:px-0 mx-auto py-12">
        <div className="grid grid-cols-1 gap-6">
          {/* Video Section */}
          <div className="flex border border-zinc-300/26 md:px-0 flex-col overflow-hidden">
          ...
          {/* Map Section */}
          <div className="flex flex-col border border-zinc-300/26 overflow-hidden">
            ...
            <div className="py-5 px-4 bg-white">
              ...
              <Link href="/routes">
                <button
                  className="py-2.5 px-3 rounded-lg mt-4 font-medium text-zinc-100 text-sm bg-zinc-900 w-32"
      ...
      {/* Bottom Bar */}
      <section className="fixed flex gap-2 justify-center items-center z-40 h-16 shadow-xl bg-white w-full bottom-0 pt-2 pb-6 px-4">
        <button
          className="w-10 h-10 md:w-full flex justify-center items-center gap-2"
        ...
        <button
          className="border h-10 border-zinc-400/45 flex justify-center items-center gap-2 rounded w-full hover:bg-zinc-50"
